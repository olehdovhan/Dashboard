...
struct TotalUsersCollectionModel {
  ...
  static func fetchDashboard() -> [TotalUsersCollectionModel] {
    let firstItem = TotalUsersCollectionModel(percents: "50%",
                                              title: "Total Users Now",
                                              description: "Lorem Ipsum is simply dummy text of the print ing and type setting industry. Lorem Ipsum has been the industry's.",
                                              target: "Target Users 2000 user",
                                              less: "less 1000 user")
    let secondItem = TotalUsersCollectionModel(percents: "49%",
                                               title: "Active Users",
                                               description: "Lorem Ipsum is simply dummy text of the print ing and type setting industry. Lorem Ipsum has been the industry's.",
